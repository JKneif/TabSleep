...
(function (global) {
  ...
  // v0.2.1: reduced from 8h to 4h. The 8h figure assumed the user
  // leaves tabs asleep overnight; in practice most discards happen
  // mid-workday and the tab is restored within 2-4 hours. The next
  // tick caps actual sleep at this value so daily totals never
  // exceed what we promised.
  const ASSUMED_SLEEP_HOURS = 4;
