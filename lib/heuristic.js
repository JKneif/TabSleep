...
(function (global) {
  ...
  // v0.4: relaxed thresholds. v0.2's aggressive settings discarded
  // tabs too often for typical users. Power users can tighten these
  // in one file; this is the new default.
  const DISCARD_THRESHOLD = 40;
  ...
  const LONG_TASKS_THRESHOLD = 4;
  const WS_RECONNECTS_THRESHOLD = 2;
  const LAYOUT_SHIFTS_THRESHOLD = 6;
